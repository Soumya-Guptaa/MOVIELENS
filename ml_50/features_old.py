...
# Reshape the ml dataset into a tensor
ratings = torch.tensor(ratings_df.values, dtype=torch.float32).view(-1, seq_len, output_dim)
...
# Reshape the ml dataset into a tensor
True_ratings = torch.tensor(True_ratings_df.values, dtype=torch.float32).view(-1, seq_len, output_dim)
